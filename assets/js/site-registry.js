...
(function (global) {
  ...
  var PAGE_REGISTRY = [
    ...
    { path: '/business/mobile/roaming/internet-packs/', title: 'Roaming internet packs', parent: '/business/mobile/roaming/', branch: 'b2b', status: 'built',
      links: ['/business/mobile/roaming/internet-packs/500mb/', '/business/mobile/roaming/internet-packs/2gb/',
              '/business/mobile/roaming/internet-packs/5gb/', '/business/mobile/roaming/internet-packs/10gb/',
              'https://kabinetim.azercell.com/',
              'https://www.azercell.com/en/corporate/mobile-communications/roaming/roaming-data-packages.html'] },
    { path: '/business/mobile/roaming/internet-packs/500mb/', title: '500MB roaming internet pack', parent: '/business/mobile/roaming/internet-packs/', branch: 'b2b', status: 'built' },
    { path: '/business/mobile/roaming/internet-packs/2gb/', title: '2GB roaming internet pack', parent: '/business/mobile/roaming/internet-packs/', branch: 'b2b', status: 'built' },
    { path: '/business/mobile/roaming/internet-packs/5gb/', title: '5GB roaming internet pack', parent: '/business/mobile/roaming/internet-packs/', branch: 'b2b', status: 'built' },
    { path: '/business/mobile/roaming/internet-packs/10gb/', title: '10GB roaming internet pack', parent: '/business/mobile/roaming/internet-packs/', branch: 'b2b', status: 'built' },
    ...
    { path: '/business/campaigns/archive/', title: 'Campaigns archive', parent: '/business/campaigns/', branch: 'b2b', status: 'built',
      links: ['/business/campaigns/', '/business/campaigns/archive/lenovo-a2016-lte/',
              ...
              '/business/campaigns/archive/iphone-16-and-17/', '/business/campaigns/archive/my-business-wifi/',
              '/business/campaigns/archive/new-company-general-mobile/', '/business/campaigns/archive/new-company-lenovo/'] },
    { path: '/business/campaigns/archive/iphone-16-and-17/', title: 'iPhone 16 and iPhone 17 Campaigns for Corporate Customers', parent: '/business/campaigns/archive/', branch: 'b2b', status: 'built' },
    { path: '/business/campaigns/archive/20gb-20-azn/', title: '20GB 20 AZN', parent: '/business/campaigns/archive/', branch: 'b2b', status: 'built' },
    { path: '/business/campaigns/archive/new-company-general-mobile/', title: 'New company campaign — General Mobile', parent: '/business/campaigns/archive/', branch: 'b2b', status: 'built' },
